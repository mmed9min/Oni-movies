...
const HeroSection = () => {
    return (
        <div className='heroSection max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 mt-5'>
            ...
            <div className="hero__movie__details">
                <div className="hero__movie__infos flex items-center">
                    <div className="hero__movie__rating flex mr-2">
                        <img src={imdp} alt="" className='mr-2 h-6'  />
                ...
                <div className="hero__movie__title mt-4 mb-4">
                    <h1 className='text-5xl text-white font-medium'>The Matrix Resurrections</h1>
                </div>
                <div className="hero__movie__descrip">
                    <p className='text-white text-sm'>Return to a world of two realities: one, everyday life; the other, what lies behind it. To find out if his reality is a construct, to truly know himself, Mr. Anderson will have to choose to follow the white rabbit once more.</p>
                </div>
                <div className="hero__movie__btns mt-5 flex">
            ...
            <div className="heroCards__row flex justify-between items-center">
                <div className="flex">
